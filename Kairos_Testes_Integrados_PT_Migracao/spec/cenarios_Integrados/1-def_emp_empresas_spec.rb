describe 'empresas', :empresas do
  ...
  it 'CT001 Inserir uma nova empresa', :ct001_empresas do
    ...
    msg = find('div[id=Summary-Field-Index]')
    expect(msg).to have_content 'A Empresa foi criada com sucesso'
  end
end
